    ...
    return (
      <div>
            ...
            <div className="row">
              <div className="col s12">
                <h2 className="center header text_h2">
                  <span className="span_h2"> Phasellus </span>vestibulum lorem
                  risus, nec suscipit lorem <span className="span_h2"> </span>
                </h2>
              </div>
              ...
              <div className="col s12 m4 l4">
                <div className="center promo promo-example">
                  ...
                  <h5 className="promo-caption">फास्टेस्ट मैच </h5>
              ...
              <div className="col s12 m4 l4">
                <div className="center promo promo-example">
                  ...
                  <h5 className="promo-caption">समर्थन और सलाह</h5>
                  <p className="light center"></p>
                </div>
              </div>
            </div>
        ...
        <div className="section scrollspy" id="work">
          <div className="container">
            <h2 className="header text_b">सफलता की कहानियां</h2>
            <div className="row">
              <div className="col s12 m4 l4">
                <div className="card">
              ...
              <div className="col s12 m4 l4">
                <div className="card">
                  ...
                  <div className="card-reveal">
                    <span className="card-title grey-text text-darken-4">
                      जोड़ी <i className="mdi-navigation-close right"></i>
                    </span>
                    <p>
                      Here is some more information about this project that is
                      only revealed once clicked on.
        ...
        <div className="section scrollspy" id="team">
          <div className="container">
            <h2 className="header text_b">हमारी टीम </h2>
            <div className="row">
                ...
                <div className="card card-avatar">
                  ...
                  <div className="card-content">
                    <span className="card-title activator grey-text text-darken-4">
                      ...
                      <small>
                        <em>
                          <a className="red-text text-darken-1" href="#">
                            संस्थापक
                          </a>
                        </em>
                      </small>
                    ...
                    <p>
                      <a className="blue-text text-lighten-2" href="">
